...
| G-2 | Quality → Fusion Mapping | No empirical characterization of how fusion strategy can adapt to data quality levels | Provable Dynamic Fusion (theory only); ActionMAE (missing modality, not quality-adaptive) | Critical |
